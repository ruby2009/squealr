...
ActiveRecord::Schema.define(version: 20170302212121) do
  ...
  create_table "squeals", force: :cascade do |t|
    t.text     "body"
    t.integer  "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_squeals_on_user_id", using: :btree
  end
